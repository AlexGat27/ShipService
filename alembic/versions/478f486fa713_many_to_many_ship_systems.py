"""many to many ship systems

Revision ID: 478f486fa713
Revises: 2c0b57536597
Create Date: 2024-05-07 23:39:50.147129
...
def upgrade() -> None:
    ...
    op.drop_constraint('ship_system_ship_id_fkey', 'ship_system', type_='foreignkey')
